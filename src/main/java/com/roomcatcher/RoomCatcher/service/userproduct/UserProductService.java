...
public class UserProductService {
    ...
    // 찜한 매물에서 삭제
    @Transactional
    public void deleteUserProduct(DeleteUserProductDTO deleteUserProductDTO){

        // 해당하는 UserProduct를 삭제하기
        // 성공 여부 반환
        UserProduct userProduct = userProductRepository.findByUserIdAndProductId(deleteUserProductDTO.getUserId(), deleteUserProductDTO.getProductId())
                .orElseThrow(IllegalArgumentException::new);
